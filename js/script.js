...
function pressKey(e) {
    ...
    if(!funcionEnEjecucion) {
            ...
            if (imgIndice != 8) {
                ...
                if (imgIndice == 8) {
                    ...
                    if(vidas == 0){
                        ...
                        titleLose.innerHTML = "¡Perdiste tus 3 vidas!"
                        p.innerHTML = `Palabras acertadas: ${numAcertadas}`;
        ...
        if (palabraAdivinada == 3 && nivelActual == 3) {
            ...
            titleWin.innerHTML = "¡Pasaste el juego!"
            ...
            buttonAdvanceLevel.innerHTML = "Volver a jugar";
            ...
            buttonAdvanceLevel.addEventListener("click", ()=>{
                ...
                const titleWin = document.querySelector(".title-win");
                titleWin.innerHTML = "¡Adivinaste!"
                timeTextWin.innerHTML = ``;
                const buttonAdvanceLevel = document.getElementById('nextLevel');
                buttonAdvanceLevel.innerHTML = "Siguiente palabra!";
                resetGame();
            });
            win.style.display = "block";
        }
...
function resetGame(){
    ...
    const titleLose = document.querySelector(".title-lose");
    const buttonContinue = document.getElementById("continue");
    titleLose.innerHTML = "¡Perdiste una vida!"
