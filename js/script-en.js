...
function pressKey(e) {
    ...
    if(!funcionEnEjecucion) {
            ...
            if (imgIndice != 8) {
                ...
                if (imgIndice == 8) {
                    ...
                    if(vidas == 0){
                        ...
                        titleLose.innerHTML = "¡You lost your 3 lives!"
                        p.innerHTML = `Right words: ${numAcertadas}`;
        ...
        if (palabraAdivinada == 3 && nivelActual == 3) {
            ...
            titleWin.innerHTML = "¡You won the game!"
            ...
            buttonAdvanceLevel.innerHTML = "Play again";
            ...
            buttonAdvanceLevel.addEventListener("click", ()=>{
                ...
                const titleWin = document.querySelector(".title-win");
                titleWin.innerHTML = "¡You guessed it!"
                timeTextWin.innerHTML = ``;
                const buttonAdvanceLevel = document.getElementById('nextLevel');
                buttonAdvanceLevel.innerHTML = "Next word!";
                resetGame();
            });
            win.style.display = "block";
        }
...
function resetGame(){
    ...
    const titleLose = document.querySelector(".title-lose");
    const buttonContinue = document.getElementById("continue");
    titleLose.innerHTML = "¡You lost a life!"
